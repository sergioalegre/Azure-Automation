#Este runbook provisions two virtual machines, an external load balancer, and various other resources required by the vms and LB
#VARIABLES NECESARIAS A CREAR PREVIAMENTE:
<!-- 
Name: VM1Name
...
Encrypted: No 
-->
#Hay que crear un runbook de tipo: "Powershell Workflow" llamado: "workflow Provision-lab-textual-workflow" con este contenido:
